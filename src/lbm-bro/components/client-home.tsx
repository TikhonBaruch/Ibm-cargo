  ...
  return (
    <div className="go-dash">
        ...
        <div className="go-quick-wrap">
          ...
          {markOpen ? (
            <DesignerStub
              ...
              gap="В domain LBM модуля «Честный знак» нет. На ibm-cargo — только визуал и описание замысла."
              compact
            />
          ) : null}
        </div>
      ...
      <DesignerStub
        ...
        gap="В LBM тарифы EXPRESS/STANDARD/PRO (D10), freemium-гейта нет. Копирайт плитки ниже — визуальный, оплата пойдёт через domain позже."
        compact
      />
      ...
      <div className="go-svc-wrap">
        ...
        <DesignerStub
          ...
          gap="Перевозка в LBM — domain есть, клиентский UI default off (D27). ТО «под ключ» как отдельный продукт — нет. Брокер QC — есть через pay→queue."
          compact
        />
