...
export function previewOrigin(env: EnvBag = process.env): string {
 ...
 */
export function ensureNextAuthUrlForRuntime(env: EnvBag = process.env): string {
 ...
 */
export function ensureAuthSecret(env: EnvBag = process.env): string {
...
export function bootAuthEnv(env: EnvBag = process.env): { url: string; secret: string } {
