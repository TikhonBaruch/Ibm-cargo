...
8. Не коммитить `.env` / секреты. Фронтенд-подрядчик: [`ved-frontend-boundary.mdc`](docs/knowledge/ved-frontend-boundary.mdc) — без инъекций и прямого доступа к БД / S3 / AI-контейнерам.
