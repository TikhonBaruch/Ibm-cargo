...
| `npm run probe:hint-gap` | Offline gap probe (`scripts/hint-gap-probe.ts`) — golden 50-row dictionary |
| `npm run probe:hint-gap:full` | Observe `--full` household corpus (~516) |
