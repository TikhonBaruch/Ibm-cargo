...
| Операции | Брокеры | `/brokers` | Модерация · acceptingJobs · профиль | Одобрить / Отклонить · пауза · **drawer: specialization/languages/about** |
...
| Каталог | Тарифы | `/tariffs` | price / share / slaHours | Сохранить |
