...
docs/knowledge/              # единая KB (этот каталог)
  ...
  plan-hint-coverage-p0.md            # coverage P0: apparel attr + plant dairy + mouse≠PC
...
| ТН ВЭД: точность всех hint-packs | [`plan-hint-chains-precision-audit.md`](./plan-hint-chains-precision-audit.md) · [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md) (attr/plant/mouse) |
