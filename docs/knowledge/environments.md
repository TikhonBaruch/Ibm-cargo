...
| Env | Смысл |
|-----|--------|
| `DATABASE_URL` | Mode A / Vercel — **только** Postgres LBM (**D36**: не БД taurus/llm). MVP живёт **без** sibling `../llm` — [`plan-autonomy-outside-taurus.md`](./plan-autonomy-outside-taurus.md) |
