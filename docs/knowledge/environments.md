...
| Env | Смысл |
|-----|--------|
| `DATABASE_URL` | Mode A / Vercel — **только** Postgres LBM: `pg4.sweb.ru:5433/newlsu_lbm` (`sslmode=require`) · пароль в `.env` / Vercel · [`database.md`](./database.md) · **D36** не БД taurus/nested `./llm` |
