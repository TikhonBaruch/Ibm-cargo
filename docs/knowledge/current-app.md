...
| Полный каталог ТН ВЭД | **C18–C32 + C35a–e + morph H1–H5 на main**. **Coverage P0–P2** (#43): WRONG fixes + packs `fruit-fresh` / `woven-apparel` / `prepared-food`; open: art/bags/watches/bev/audio/furniture/tires/bikes · [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md). **Precision:** P0/P1/P5 #38 · **P4+P6** (this PR) produce attr-suggest clarify + staging · P2 #39 · P3 #40 · P7 open · [`plan-hint-chains-precision-audit.md`](./plan-hint-chains-precision-audit.md). Prod https://ibm-cargo-phi.vercel.app. | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-classify-cascade-c23.md`](./plan-classify-cascade-c23.md) · [`plan-c32-preview-devex.md`](./plan-c32-preview-devex.md) |
