...
| Полный каталог ТН ВЭД | **Coverage P0–P3** (#43/#44). **P4** (this PR): pharma/books/appliances/lamps/fasteners/paint/pet-food/agri-inputs (33 packs). Live animals POLICY. Plan [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md) §P4. Prod https://ibm-cargo-phi.vercel.app. | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) |
