...
| Полный каталог ТН ВЭД | **C18–C32 на main** (#16 + #27) + **C35a** (#33 LLM skip) + morph hints H1–H3 (огурец≠йогурт). Prod https://ibm-cargo-phi.vercel.app — `smoke:mvp` **PASS** 2026-08-31. Preview SSO = human ops. · [`plan-c35-offline-first-hs.md`](./plan-c35-offline-first-hs.md) · [`plan-tnved-hint-chains-audit.md`](./plan-tnved-hint-chains-audit.md) | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-classify-cascade-c23.md`](./plan-classify-cascade-c23.md) · [`plan-c32-preview-devex.md`](./plan-c32-preview-devex.md) |
