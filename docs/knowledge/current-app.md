...
| **Прецеденты БД-2 (compose/local)** | `verified_determinations` + pgvector `precedent-v2`; precedent-first create; write-back на approve | `smoke:precedent-csv` · `smoke:precedent-vector` · [`plan-precedent-bulk.md`](./plan-precedent-bulk.md) |
...
| Полный каталог ТН ВЭД | **C18–C32 на main** (#16 + #27): lab ∪ ФНС + cascade + pay-first + layers B/D/E/G + Preview DevEx docs. Prod https://ibm-cargo-phi.vercel.app — `smoke:mvp` **PASS** 2026-08-31; search HIT кепка/ноутбук. Preview SSO bypass = human ops. C35 = brief only. · [`plan-merge-ops-unblock.md`](./plan-merge-ops-unblock.md) | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-classify-cascade-c23.md`](./plan-classify-cascade-c23.md) · [`plan-c32-preview-devex.md`](./plan-c32-preview-devex.md) |
...
**Mobile client (план):** [`plan-mobile-client-lbm.md`](./plan-mobile-client-lbm.md) — as-is responsive `/cabinet`; native/PWA hold. Сначала зелёный `npm run test:ci`.
