...
| Полный каталог ТН ВЭД | **C18–C32 + C35a–e + morph H1–H5 на main**. Hint precision P0–P7 in flight (#39–#42). **Coverage P0** (this cycle): apparel attr split + plant dairy + mouse≠PC · [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md) · [`plan-hint-chains-precision-audit.md`](./plan-hint-chains-precision-audit.md). Prod https://ibm-cargo-phi.vercel.app. · [`plan-c35-offline-first-hs.md`](./plan-c35-offline-first-hs.md) · [`plan-tnved-hint-chains-audit.md`](./plan-tnved-hint-chains-audit.md) | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-classify-cascade-c23.md`](./plan-classify-cascade-c23.md) · [`plan-c32-preview-devex.md`](./plan-c32-preview-devex.md) |
