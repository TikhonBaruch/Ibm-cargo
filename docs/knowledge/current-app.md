...
| Полный каталог ТН ВЭД | **Coverage P0–P2** on main (#43). **P3** (this PR): art/bags/watches/beverages/speakers/furniture/tires/cycles (25 packs). Open: pharma/books/appliances/hardware/paint/pets/agri · [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md). Prod https://ibm-cargo-phi.vercel.app. | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) |
