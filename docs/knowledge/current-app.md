...
| Полный каталог ТН ВЭД | **C18–C32 + C35a/c + morph H1–H3 на main**; **C35d/e + H4/H5** (этот PR: CN fingerprint, offline-hit ≥60%, produce aliases 0707/0702/0701, `test:tnved-morphology`). Prod https://ibm-cargo-phi.vercel.app. · [`plan-c35-offline-first-hs.md`](./plan-c35-offline-first-hs.md) · [`plan-tnved-hint-chains-audit.md`](./plan-tnved-hint-chains-audit.md) | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-classify-cascade-c23.md`](./plan-classify-cascade-c23.md) · [`plan-c32-preview-devex.md`](./plan-c32-preview-devex.md) |
