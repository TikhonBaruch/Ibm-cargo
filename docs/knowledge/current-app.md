...
| Полный каталог ТН ВЭД | **C18 2026-08-27** lab ∪ ФНС; **C19 2026-08-28** инвойсные имена + ФТС 641/ЕЭК 2026 notes (`--search-extras`). **31 706** кодов · **14 948** листьев · **15 015** вариаций. Production: https://ibm-cargo-phi.vercel.app | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) · [`plan-tnved-invoice-enrich.md`](./plan-tnved-invoice-enrich.md) |
