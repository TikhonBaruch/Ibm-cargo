...
| Полный каталог ТН ВЭД | **Coverage P0–P6** (this PR): 53 packs (+rugs/sports/camping/optics/med/pet-acc/displays/printers/auto/security…). Plan [`plan-hint-coverage-p0.md`](./plan-hint-coverage-p0.md). Prod https://ibm-cargo-phi.vercel.app. | [`plan-lbm-bro-tnved-catalog.md`](./plan-lbm-bro-tnved-catalog.md) |
