...
|---|----------|-------------------------|
| **1** | Канон: [`product.md`](./product.md) (D27), [`decisions.md`](./decisions.md), [`skeleton.md`](./skeleton.md) checklist; при данных — [`data-model.md`](./data-model.md) / [`calculation-fields.md`](./calculation-fields.md); **D36** — не трогать taurus/llm | Понятно: зачем фича, кого не ломаем, hold Growth, изоляция матрицы |
