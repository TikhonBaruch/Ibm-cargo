...
|------|-------|-----------|---------|
| 2026-08-25 | full split D36 | **done** | nested `llm/` removed from git + gitignore; `test:structure` forbids tracked `llm/` — [`plan-full-split-ibm-cargo.md`](./plan-full-split-ibm-cargo.md) |
| 2026-08-25 | `smoke:mvp` (post full split) | **PASS** #47936 DONE | after `git rm -r llm/`; CI 508 PASS |
| 2026-08-25 | `smoke:mvp` (autonomy / D36) | **PASS** #47935 DONE | zero coupling path — [`plan-zero-llm-coupling.md`](./plan-zero-llm-coupling.md) |
