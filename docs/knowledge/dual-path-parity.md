...
| GET TN VED search | `searchTnvedCodes` + `total` | `GET /v1/tnved/search` | whole-word title/notes · notes secondary · alias boost (морс/HDD/ноутбук) · `heading=1` / empty q → `{ items:[], total }` |
